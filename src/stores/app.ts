...
export const PREFERENCE_NOTICE_WHEN_MENTIONED = 'PREFERENCE_NOTICE_WHEN_MENTIONED'
type PREFERENCE_KEYS = typeof PREFERENCE_DISPLAY_META_ENABLED | typeof PREFERENCE_NOTICE_WHEN_MENTIONED
